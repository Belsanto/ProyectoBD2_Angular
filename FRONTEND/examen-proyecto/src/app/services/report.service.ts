...
export class ReportService {
  private baseUrl = 'https://0e49-181-53-99-60.ngrok-free.app/reporte'; // Asegúrate de que esta URL sea correcta
  ...
  getNotasEstudiantes(): Observable<any> {
    return this.http.get(`https://0e49-181-53-99-60.ngrok-free.app/obtener-notas`, { headers: this.getHeaders() });
  }
}
